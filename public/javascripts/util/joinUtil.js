...
function validateUserName(username) {
    ...
    if (reservedUsernames.has(username)) return usernameInvalid;
    return 'OK';
}

function validatePassword(password) {
    if (password.length < 4) return passwordTooShort;
    return 'OK';
}
